...
export default function WindowsPage() {
  ...
  const liveArticles = getNewsForCategory('windows', 30)
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 md:px-6 py-8">
      <nav className="flex items-center gap-2 text-sm text-on-surface-variant mb-6">
        ...
        <span>/</span>
        <span className="text-on-surface font-semibold">Windows</span>
      </nav>

      <div className="mb-8">
        <h1 className="font-inter font-bold tracking-tight text-3xl md:text-4xl text-on-surface">Windows Updates</h1>
        <p className="text-on-surface-variant mt-2">Stay up to date with the latest Windows 11, Windows 12, and Windows Server news — including feature updates, security patches, and insider builds.</p>
      </div>
